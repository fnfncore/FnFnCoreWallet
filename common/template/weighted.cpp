...
void CTemplateWeighted::GetTemplateData(rpc::CTemplateResponse& obj, CDestination&& destInstance) const
{
    obj.weighted.nRequired = nRequired;
    for (const auto& keyweight : mapPubKeyWeight)
    {
        rpc::CTemplatePubKeyWeight pubkey;
...
bool CTemplateWeighted::SetTemplateData(const rpc::CTemplateRequest& obj, CDestination&& destInstance)
{
